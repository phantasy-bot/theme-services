...
Service-oriented business theme for offerings, lead capture, trust blocks, and conversion flows.

- Repo URL: https://github.com/phantasy-bot/theme-services
...
```bash
phantasy extensions install theme services
```
